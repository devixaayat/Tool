...
def logo():
    ...
    os.system('echo -e "\n\n    \n  ______   _______          _________(  __  \ (  ____ \|\     /|\__   __/| (  \  )| (    \/| )   ( |   ) (   | |   ) || (__    | |   | |   | |   | |   | ||  __)   ( (   ) )   | |   | |   ) || (       \ \_/ /    | |   | (__/  )| (____/\  \   /  ___) (___(______/ (_______/   \_/   \_______/ \n-----------------------------------------------\n\n\xe2\x9e\xa3 Edit By   : Devi \n\xe2\x9e\xa3 Facebook  : 乛Mʀ Dɘv'ɩ O.oメ\n\xe2\x9e\xa3 Github    : https://github.com/Devixayyat\n\xe2\x9e\xa3 Whatsapp  : +9232633******\n\n-----------------------------------------------" | lolcat -a -d 2 -s 50')
...
def menu():
    ...
    print '\x1b[94;1m  [3]  Team RED-mafia (RK)'
...
def mk1():
    ...
    print '\x1b[96;1m  [4]  no gf single hon'
